...
class AppColors{
  static const Color primary = Color(0xFF9AC225);
  ...
  static const Color screenColor = Color(0xFFF7F6FD);

  static const Color lightBlack = Color(0xFF12163C);
  static const Color darkGrey = Color(0xFFAAAAAA);
  static const Color extraBlack = Color(0xFF12163C);
  static const Color red = Color(0xFFFF0000);
  static const Color blue = Color(0xFF1313CE);
